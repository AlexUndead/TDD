...
class MyListTest(FunctionalTest):
    ...
    def create_pre_authenticated_session(self, email):
        ...
        ## страницы 404 загружаются быстрее всех!
    ...
    def test_logged_in_users_lists_are_saved_as_my_lists(self):
        ...
        self.create_pre_authenticated_session('Alex_Undead_92@bk.ru')
        ...
        self.wait_for(
            lambda: self.browser.find_element_by_link_text(self.browser.current_url, second_list_url)
        )
